...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2023-02-21T19:33:00Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2023-01-22T19:45:10Z"), OrderStatus.WAITING_PAYMENT, u1);
